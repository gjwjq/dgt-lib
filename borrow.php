<?php
  ...
  $checkRent = DB::fetch("SELECT * FROM rent WHERE userId = '$userId' AND status = '대여중'");
  ...
  $res1 = DB::exec("INSERT INTO rent (userId, bookIdx, rentDate, returnDate, status) VALUES ('$userId', '$bookIdx', NOW(), '$returnDate', '대여중')");
