        ...
        <div class="books">
            <?php foreach ($rentList as $rent) : ?>
                <div class="book">
                    ...
                    <a href="returnProcess.php?rentIdx=<?= $rent['idx'] ?>&bookIdx=<?= $rent['bookIdx'] ?>" 
                       class="btn" 
                       style="width: 100%; text-align: center; background: #0f172a; color: #becfe7; padding: 10px; margin-top: 10px;"
